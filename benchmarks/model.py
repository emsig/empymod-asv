...
class Dipole:
    ...
    def time_dipole_time(self, loop):
        model.dipole(rec=[np.arange(1, 4)*1000, np.zeros(3), 1000], signal=0,
                     **self.model)
